...
class GeminiTester {
  ...
  async testBookingScenarios() {
    ...
    const bookingTests = [
      ...
      },
      {
        ...
        description: "User requests a lesson on a Saturday, which is outside of the Mon-Fri working days."
      },
      {
  ...
  async printSummary() {
    return new Promise((resolve) => {
      ...
      const successRate = this.testResults.total > 0 ? (this.testResults.passed / this.testResults.total * 100).toFixed(1) : "0.0";
